...
public class TriangleDrawerPartB_1 extends JFrame {
    private Point pointA = new Point(100, 100);
    private Point pointB = new Point(300, 100);
    private Point pointC = new Point(200, 300);
    private Point pointP = new Point(200, 200);

    public TriangleDrawerPartB_1() {
    ...
    public void paint(Graphics g) {
        ...
        // Draw point P in a different color
        ...
        // Determine if point P is inside, outside, or on an edge of the triangle
        ...
        if (areaPAB == 0 || areaPBC == 0 || areaPCA == 0) {
            ...
            g.drawString("Point P is inside triangle ABC", 10, getHeight() - 30);
        } else {
            g.setColor(Color.RED);
            g.drawString("Point P is outside triangle ABC", 10, getHeight() - 30);
        }
    }
